  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button id='add-review' className="ml-4 px-4 py-2 border border-black rounded-full hover:bg-black hover:text-white transition ease-in-out duration-200" variant={"ghost"} size="lg">
        ...
        <DialogFooter>
          ...
          {user && (
            <>
              ...
              <DialogClose asChild>
                <Button id="submit" type="submit" onClick={handleSave}>
                  Submit
                </Button>
              </DialogClose>
            </>
